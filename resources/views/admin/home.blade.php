				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-teal panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-shopping-cart color-blue"></em>
							@if(isset($hoadon))
							<?php 
							if(count($hoadon) > 1000){
							$number = count($hoadon) / 1000;
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-blue panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-truck color-orange"></em>
							...
							<?php 
							if(count($phieuxuatkho) > 1000){
							$number = count($phieuxuatkho) / 1000;
						//if you want 2 decimal digits
							$newVal = number_format($number,3) . 'k';
							}else{
								$newVal = count($phieuxuatkho);
							}
							?>
							<div class="large">{{ $newVal }}</div>
							@else
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-orange panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-users color-teal"></em>
							@if(isset($khachhang))
							<?php 
							if(count($khachhang) > 1000){
							$number = count($khachhang) / 1000;
						//if you want 2 decimal digits
							$newVal = number_format($number,3) . 'k';
							}else{
								$newVal = count($khachhang);
							}
							?>
							<div class="large">{{ $newVal }}</div>
							@else
			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						Tổng quan về lưu lượng trang web
			...
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
						<h5>Đơn Đặt Hàng Trong Tháng</h5>
						<?php $i = 200 ?>
						<div class="easypiechart" id="easypiechart-blue" data-percent="{!! (count($date_hoadon)*100)/$i !!}" ><span class="percent">{!! (count($date_hoadon)*100)/$i !!}%/{{$i}}</span></div>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
						<h5>Đơn Giao Hàng Trong Tháng</h5>
						<div class="easypiechart" id="easypiechart-orange" data-percent="{!! (count($date_phieuxuatkho)*100)/$i !!}" ><span class="percent">{!! (count($date_phieuxuatkho)*100)/$i !!}%/{{$i}}</span></div>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3">
				...
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
						...
						@foreach($date_phieunhap1 as $phieunhap1)
							<?php
							$pnct = DB::table('phieu_nhap_chi_tiets')->where('id_phieunhap',$phieunhap1->id)->get();
							?>
							@foreach($pnct as $pnct1)
						...
						//if you want 2 decimal digits
							$newVal = number_format($number,0) . 'm';
						}
						else if($total >= 1000){
							$number = $total / 1000;
						//if you want 2 decimal digits
							$newVal = number_format($number,0) . 'k';
							}else{
								$newVal = $total;
							}
							?>
